...
- 📄 `Day_XX`: Günlük notlar ve kod bilgisi
...
| Gün | Dosya | Konu |
|-----|-------|------|
| 1   | [Day_01](Day_01) | Bilgisayarların çalışma prensibi, sayı sistemleri, değişkenlere giriş|
| 2   | [Day_02](Day_02) | Veri Tipleri (sayı, int, float, string vb.) |
| 3   | [Day_03](Day_03) | Veri Yapıları (index, slicing, liste, tip dönüşümleri) |
| 4   | [Day_04](Day_04) | Sözlük, set, tuple, bool |
| 5   | [Day_05](Day_05) | 10 sorudan oluşan Quiz çalışması |
| 6   | [Day_06](Day_06) | Kontroller (If, elif, else yapısı) ve Döngüler (for, break, continue, pass yapısı) |
| 7   | [Day_07](Day_07) | Döngüler (while), İleri seviye işlemler(f-string, Built-in Functions, Built-in Module, List Comprehension) |
| 8   | [Day_08](Day_08) | 10 sorudan oluşan Quiz-2 çalışması |
| 9   | [Day_09](Day_09) | Fonksiyonlar, Map, Filter, Lambda Kullanımı, Fonksiyonel Kapsam (Scope), LEGB Kuralı|
| 10  | [Day_10](Day_10) | Sınıflar(Classes), Sınıf Örnekleri|
| 11  | [Day_11_1](Day_11_1) |OOP – Nesne Yönelimli Programlama Nedir?, Inheritance, Polymorphism, Encapsulation, Abstraction|
| 11  | [Day_11_2](Day_11_2) |Özel Methodlar, Hatalar, Dosyalar, Type Annotation|
| 12  | [Day_12](Day_12) |10 sorudan oluşan Quiz-3 çalışması |
| 13  | [Day_13](Day_13) |PyCharm Windows Kurulumu|
| 14  | [Day_14](Day_14) |Modül ve Paket Kullanımları|
| 15  | [Day_15](Day_15) |SQL'e Giriş, Temel Komutlar, Veri Tipleri, Öğrenim Kaynakları|
| 16  | [Day_16](Day_16) |SQL ve Python, Tablo Oluşturma, Okuma, Yazma ve Silme|
| 17  | [Day_17](Day_17) |SQL Sınavı|
| 18  | [Day_18](Day_18) |İstatistik Türleri, Popülasyon, Örneklem, Varyans, Merkezi Yönelim, Yayılım Ölçüleri|
| 19  | [Day_19](Day_19) |Histogram, Yüzdelik, Çeyreklik, Kovaryans, Korelasyon, Bağımlı ve Bağımsız Olaylar|
| 20  | [Day_20](Day_20) |İstatistik Sınavı|

📌 Her yeni günün dosyası eklendikçe tablo güncellenecektir.
